          ...
          child: Column(
            ...
            children: [
              ...
              t.listItemDescription(
                  ...
                  itemDescription:
                      'Peclutamiento, contratación y selección del personal'),
              t.paragraph(
              ...
              t.paragraph(
                  ...
                  textAlign: TextAlign.justify),
              t.paragraph(
                  'enviando un correo electrónico a computo@ite.edu.mxLa negativa para el uso de sus datos personales para estas finalidades no podrá ser un motivo para que le neguemos los servicios y productos que solicita o contrata con nosotros.',
                  textAlign: TextAlign.justify),
              t.subtitle(
              ...
              ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return t.listItemDescription(
                      icon: const Icon(
                        Icons.keyboard_arrow_right,
                        color: Colors.black,
                      ),
                      itemDescription: datos[index],
                    );
                  }),
              const SizedBox(
                height: 5,
              ...
              t.listItemDescription(
                ...
                itemDescription: 'Datos de salud',
              ),
              t.subtitle(
                ...
                Row(
                  ...
                  children: [
                    RichText(
                      ...
                      text:
                          'Dirección General\n del Tecnológico \nNacional de \nMéxico',
                      style: textStyleMonserrat(color: Colors.black),
                    )),
                    RichText(
                        text: TextSpan(
                            text:
